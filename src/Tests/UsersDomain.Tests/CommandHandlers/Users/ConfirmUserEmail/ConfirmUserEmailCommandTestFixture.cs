...
namespace UsersApplication.Tests.CommandHandlers.Users.ConfirmUserEmail
{
    ...
    public sealed class ConfirmUserEmailCommandTestFixture : CommandHandlerFixtureBase
    {        
        public ConfirmUserEmailHandler CommandHandler { get; }
        ...
        public ConfirmUserEmailCommandTestFixture()
        {
            ...
            CommandHandler = new ConfirmUserEmailHandler(UnitOfWorkMock.Object);
